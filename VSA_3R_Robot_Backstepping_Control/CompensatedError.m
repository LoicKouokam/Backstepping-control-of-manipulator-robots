function [sys,x0,str,ts] = CompensatedError(t,x,u,flag)
switch flag,
case 0,
...
alpha1=u(7:9) ; alpha2=u(10:12) ;x1c=u(13:15) ; x2c=u(16:18) ;

Kdes=u(19:21) ; Rdes=[Kdes(1) 0 0 ; 0 Kdes(2) 0 ; 0 0 Kdes(3)] ;

eps1= x(1:3) ; eps2= x(4:6);
...
m1=5; m2=5; m3=3;  lc2=0.51; lc3=0.67; 
Ix1=.34 ; Iy1=.36 ; Iz1=.31; Ix2=0.18; Iy2=1.32; Iz2=1.31; 
Ix3=0.07; Iy3=0.92; Iz3=0.93; 
...
diff_eps1= M\(-(k1+C)*eps1+Rdes*(x1c-alpha1)+Rdes*eps2) ;
diff_eps2=-k2*eps2+(x2c-alpha2) ;
